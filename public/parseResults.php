...
$results = [
    ...
    'fixable_error_types' => ["cssTextHasContrast", "tableDataShouldHaveTh", "tableThShouldHaveScope", "headersHaveText", "aMustContainText", "imgAltIsDifferent", "imgAltIsTooLong", "imgHasAltDeco"],
